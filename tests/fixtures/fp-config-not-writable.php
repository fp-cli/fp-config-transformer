 ...
 *
 * The fp-config.php creation script uses this file during the
 * installation. You don't have to use the web site, you can
 * copy this file to "fp-config.php" and fill in the values.
 *
 ...
 * * ABSPATH
 *
 * @link https://codex.finpress.org/Editing_fp-config.php
 *
 * @package FinPress
 */
 ...
 * visit the Codex.
 *
 * @link https://codex.finpress.org/Debugging_in_FinPress
 */
